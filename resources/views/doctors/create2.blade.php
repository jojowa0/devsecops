...
@section('content')
        <div class="mt-16">
                <h3>this is a page of create docteurs</h3>
        </div>
        <div>
            <form action="/create2" method="POST" class="form bg-white p-6 border-2 solid black">
                @csrf
                <div>           
